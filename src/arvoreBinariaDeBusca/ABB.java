...
public class ABB {
     ...
     * Buscando o nó com a chave correspondente entrada - O(log n)
     * @param usuario Usuário a ser buscado na ABB
     * @return Usuario se existir ou {@code null} caso contrário
     */
     ...
     * @param usuario Usuário a ser adicionado na ABB
     * @return {@code true} caso seja inserido com sucesso senão {@code false}
     */
     ...
     * @return {@code true} caso seja removido com sucesso senão {@code false}
     */
	public boolean remove(Usuario usuario){
		...
		if( busca(usuario) == false ){  // -> Nó com chave correspondente não foi encontrado
			return false;
		}
        ...
        while( usuario.compareTo(aux.getUsuario()) != 0 ){     // -> BUSCANDO O NÓ QUE SERÁ REMOVIDO E ARMAZENANDO NA VARIÁVEL "auxPai"
        ...
        if( aux.getEsquerdo() == null ){	// -> O nó a ser removido, "aux", nó não tem filho à esquerda
	 ...
	 * @return	String contendo todos os dados dos usuário percorridos em ordem
	 */
