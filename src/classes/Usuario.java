...
public class Usuario implements Comparable<Usuario>{
	...
	public Usuario(String id, String nome, String senha, Boolean vip) {
		try{
			if( id == null) {
				throw new NullPointerException("variável id está null");
			}
			else {
				this.id = id;
			}	
			...
			if( nome == null){
				throw new NullPointerException("variável nome está null");	
			}
			else{
				this.nome = nome;
			}
			...
			if( senha == null) {
				throw new NullPointerException("variável senha está null");
			}
			else{
				this.senha = senha;
			}
	 ...
	 * @return  -1 indica que o objeto atual é menor que o objeto usuário
	 *          0 indica que ambos objetos são iguais
	 *          1 indica que o objeto atual é maior que o objeto usuário
	 */ 
